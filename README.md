...
│   ├── DimCharge.csv            # Charge metadata (template with example data)
│   ├── DimSanction.csv          # Sanction metadata (template with example data)
...
│   └── powerbi_screenshots/     # Screenshots showing Power BI dashboards created using the star schema output
│       ├── aod_spotlight.png    # Note: select visuals removed intentionally
...
* **Code** (R scripts, functions, transformation pipeline logic) is licensed under the **MIT License**
  → see [`LICENSE-CODE`](LICENSE-CODE)

* **Documentation & content** (methodology text, narrative documentation, diagrams, rendered PDFs, and training-style materials) is licensed under
  **Creative Commons Attribution–NonCommercial 4.0 International (CC BY-NC 4.0)**
  → see [`LICENSE-DOCS`](LICENSE-DOCS)

If you are unsure whether something is considered **code** or **documentation**, treat it as **documentation**.
