...
Maxient is excellent at what it was built for: documenting incidents, tracking case progress, and managing due process workflows. Strategic analysis is a different discipline entirely. When practitioners try to answer questions like "Are alcohol incidents increasing?" or "Which halls need more support?", they find exports that are:
...
This is not a failure of Maxient or the staff using it. It reflects a fundamental difference between systems built for case management and systems built for analysis.
...
│   ├── example_DimCharge.csv       # Charge metadata (template with example data)
│   ├── exampleDimSanction.csv      # Sanction metadata (template with example data)
│   ├── example_DimHousing.csv      # Housing attributes (template with example data)
...
├── CONTRIBUTING.md                 # Contribution guidelines and privacy rules
├── LICENSE.txt                     # CC BY-NC 4.0 license
├── PDF_Building-an-Assessment-Ready-Conduct-Data-Model.pdf   # Rendered PDF documentation
├── PULL_REQUEST_TEMPLATE.md        # Template loaded automatically when opening a pull request
├── QMD_Building an Assessment-Ready Conduct Data Model.qmd   # Source documentation (Quarto)
├── README.md                       # This file
...
3. **Update the template files** — Replace the placeholder data in the example CSV files with your institution's actual values
...
To create `hearing_officers.csv`, run Maxient System Report 914 (Hearing Officer Titles in Use). Take the first and second columns and add columns for Office and Position. This enables analysis by office and position — for example, *"How long is it taking residence life staff to resolve cases?"*

## Contributing and Pull Requests

See [CONTRIBUTING.md](CONTRIBUTING.md) for full guidance on how to engage with this project.

When opening a pull request, GitHub will automatically load a template prompting you to describe the change, confirm you are using synthetic data only, and link to any related issue or discussion. Pull requests that modify code will generally be redirected to Discussions unless they address a confirmed bug.
...
This work is licensed under [CC BY-NC 4.0](LICENSE.txt) (Creative Commons Attribution-NonCommercial 4.0 International).

You are free to share and adapt this work for non-commercial purposes with attribution. Commercial use requires explicit permission from the author. See [LICENSE.txt](LICENSE.txt) for full details.

## Contact

Joshua L. Moermond
Email: [moermondsahe@gmail.com](mailto:moermondsahe@gmail.com)
LinkedIn: [linkedin.com/in/jmoermond](https://www.linkedin.com/in/jmoermond)
